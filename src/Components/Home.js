    ...
    return (
                    ...
                    <div className="lg:w-1/2 flex flex-col items-center space-y-12">
                        ...
                        >
                            ...
                            <p className="text-lg  max-w-lg lg:mx-0 mx-auto">
                                Box Company leads the industry with customizable, eco-friendly packaging solutions. Our mission is to create impact-driven packaging that combines innovation, quality, and sustainability.
                            </p>
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="relative flex items-center">
          {/* Left Arrow Button (Outside the Card Grid) */}
          <button
            onClick={handlePrev}
            ...
            {visibleProducts.map((product) => (
              ...
              >
                ...
                <img
                  src={product.image}
                  alt={product.title}
                  className="w-350 h-35 object-cover"
                />
          ...
          {/* Right Arrow Button (Outside the Card Grid) */}
          <button
            onClick={handleNext}
